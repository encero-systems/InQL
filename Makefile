...
.PHONY: ci
ci: fmt-check test-style static-capability-gating vocab-companion-test registry-metadata build test smoke-consumer ## Same steps as GitHub Actions `inql` job
